...
public class GlideConfigModule implements GlideModule{
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        ...
        builder.setDiskCache(new InternalCacheDiskCacheFactory(context, "glide_cache", DiskCache.Factory.DEFAULT_DISK_CACHE_SIZE));
        //指定内存缓存大小
        builder.setMemoryCache(new LruResourceCache(DiskCache.Factory.DEFAULT_DISK_CACHE_SIZE));
        //全部的内存缓存用来作为图片缓存
